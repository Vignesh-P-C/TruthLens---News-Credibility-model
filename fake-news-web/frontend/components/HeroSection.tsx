...
function AnimatedStat({
  ...
  decimals?: number;
  label: string;
  isStatic?: boolean; // skip count-up, show suffix directly
}) {
...
export default function HeroSection() {
  ...
  // Parallax: orbs drift upward as the user scrolls
  ...
  return (
    ...
    >
      ...
      >
        {/* Large warm amber orb — top right */}
        <motion.div
          style={{
            position: 'absolute',
            width: '520px',
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, rgba(200,184,154,0.10) 0%, transparent 70%)',
            filter: 'blur(70px)',
            y: orbY,
          }}
        ...
        <motion.div
          style={{
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, rgba(30,77,54,0.08) 0%, transparent 70%)',
            filter: 'blur(90px)',
            y: orbY2,
          }}
        ...
        <motion.div
          style={{
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, rgba(200,160,106,0.06) 0%, transparent 70%)',
            filter: 'blur(50px)',
          }}
      ...
      <div className="relative z-10 px-16 pb-24 max-w-3xl">
        ...
        >
          ...
          second after cold start. Paste any text below.
        </motion.p>
